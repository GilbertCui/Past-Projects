...
public class AbilityPane2 extends TwoPlayers
{
    ...
    public void processChoice(ActionEvent event)
    {
		if (event.getSource() == ability1)
        {
			...
			if (ability1.getSelectionModel().getSelectedIndex() == 0)
				...
				cost.setText("Magic Cost: "+Math.abs(player2.getAllAbilityCost(ability1.getSelectionModel().getSelectedIndex())));
		}
        else if (event.getSource() == ability2)
        {
			...
			if (ability2.getSelectionModel().getSelectedIndex() == 0)
				...
				cost.setText("Magic Cost: "+Math.abs(player2.getAllAbilityCost(ability2.getSelectionModel().getSelectedIndex())));
        }
        else
        {
			...
			if (ability3.getSelectionModel().getSelectedIndex() == 0)
				...
				cost.setText("Magic Cost: "+Math.abs(player2.getAllAbilityCost(ability3.getSelectionModel().getSelectedIndex())));
        }
    ...
    {
        player2.setPlayerAbility(finalDec1);
        player2.setPlayerAbility(finalDec2);
        player2.setPlayerAbility(finalDec3);
