...
public class AttributePane extends TwoPlayers
{
    ...
    public AttributePane()
    {
        ...
        attribute1 = new Button("Damage: "+player1.getDamagePoints());
        ...
        attribute2 = new Button("Defence: "+player1.getDefencePoints());
        ...
        attribute3 = new Button("Technique: "+player1.getTechniquePoints());
        ...
        attribute4 = new Button("Speed: "+player1.getSpeedPoints());
    ...
    public void processButtonPress(ActionEvent event)
    {
        ...
        {
            player1.setDamage(1);
            attribute1.setText("Damage: "+player1.getDamagePoints());
            if (player1.getDamagePoints() == 4)
                attribute1.setDisable(true);
        }
        else if (event.getSource() == attribute2)
        {
            player1.setDefence(1);
            attribute2.setText("Defence: "+player1.getDefencePoints());
            if (player1.getDefencePoints() == 4)
                attribute2.setDisable(true);
        }
        else if (event.getSource() == attribute3)
        {
            player1.setTechnique(1);
            attribute3.setText("Technique: "+player1.getTechniquePoints());
            if (player1.getTechniquePoints() == 4)
                attribute3.setDisable(true);
        }
        else
        {
            player1.setSpeed(1);
            attribute4.setText("Speed: "+player1.getSpeedPoints());
            if (player1.getSpeedPoints() == 4)
